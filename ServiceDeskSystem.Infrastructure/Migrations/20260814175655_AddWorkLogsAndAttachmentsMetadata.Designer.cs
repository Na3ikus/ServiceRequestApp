...
namespace ServiceDeskSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260814175655_AddWorkLogsAndAttachmentsMetadata")]
    partial class AddWorkLogsAndAttachmentsMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.ContactInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.HasIndex("DeveloperId", "CreatedAt")
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            Login = "admin",
                            PasswordHash = "j96gqgfFa5fBIxf2O4SsOA==:B5POx/MZbn7F7drfOAZkJ4t9l1ZWST/69Z1vxuuMJYY=",
                            PersonId = 1,
                            Role = "Admin"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Login = "o.kovalenko",
                            PasswordHash = "R9sk3pGPJNIjJlW4MvXWWQ==:HI7h5DpvtE4iPjVJpWTpNxG3fqEmYsCOtQwTHp+s1aQ=",
                            PersonId = 2,
                            Role = "Developer"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Login = "m.shevchenko",
                            PasswordHash = "lyAOoniHhAzntbLu1W2t7g==:whLAw5K0Mk4P1SSi4w8T5f4kdQQAsZ8ChsaFAHx6GzE=",
                            PersonId = 3,
                            Role = "User"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Login = "j.smith",
                            PasswordHash = "njvZY9yzn9Md4GA1/jKFjA==:sbAI53wIg66E66sLiMzzfSYKVjGq3DsvIs6obWEGKZk=",
                            PersonId = 4,
                            Role = "User"
                        },
                        new
                        {
                            ...
                            IsActive = true,
                            Login = "a.bondarenko",
                            PasswordHash = "zlt10tCGBThVtTg2UokJxQ==:nmnrm9b9OGAFPLT/+wB7/9asxLcNoNh32lYKgUNC1tQ=",
                            PersonId = 5,
                            Role = "Developer"
                        });
                });

            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.WorkLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.Attachment", b =>
                {
                    b.HasOne("ServiceDeskSystem.Domain.Entities.Comment", "Comment")
                        .WithMany()
                        .HasForeignKey("CommentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ServiceDeskSystem.Domain.Entities.Ticket", "Ticket")
                        .WithMany("Attachments")
                        .HasForeignKey("TicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ServiceDeskSystem.Domain.Entities.User", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.AuditLog", b =>
                {
                    b.HasOne("ServiceDeskSystem.Domain.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.ContactInfo", b =>
                {
                    b.HasOne("ServiceDeskSystem.Domain.Entities.ContactType", "ContactType")
                        .WithMany("ContactInfos")
                        .HasForeignKey("ContactTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ServiceDeskSystem.Domain.Entities.Person", "Person")
                        .WithMany("ContactInfos")
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.Notification", b =>
                {
                    b.HasOne("ServiceDeskSystem.Domain.Entities.User", "ActorUser")
                        .WithMany("NotificationsCreated")
                        .HasForeignKey("ActorUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ServiceDeskSystem.Domain.Entities.User", "RecipientUser")
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.Product", b =>
                {
                    b.HasOne("ServiceDeskSystem.Domain.Entities.TechStack", "TechStack")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.HasOne("ServiceDeskSystem.Domain.Entities.User", "Developer")
            ...
            modelBuilder.Entity("ServiceDeskSystem.Domain.Entities.User", b =>
                {
                    b.HasOne("ServiceDeskSystem.Domain.Entities.Person", "Person")
                        .WithOne("User")
                        .HasForeignKey("ServiceDeskSystem.Domain.Entities.User", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
