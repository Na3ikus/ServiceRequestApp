...
public partial class NavMenu : ComponentBase, IDisposable
{
    ...
    private async Task ToggleCollapseAsync(MouseEventArgs _)
    {
    ...
    private void BuildMenu()
    {
        ...
        this._sections = new List<MenuSection> { general, workspace, management }
    ...
    {
        var section = this._sections.FirstOrDefault(s => s.Id == sectionId);
        if (section is null)
        {
            return;
        }
